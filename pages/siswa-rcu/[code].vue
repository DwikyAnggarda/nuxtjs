<script setup lang="ts">
    ...
    onMounted(() => {
        sessionStorage.path = '/siswa-rcu/detail'
        getSiswa()
    })
    ...
    const submitForm = async (i_disabled:number) => {
        ...
        let payloadData = {
            ...
            birth_date : moment(formData.value.birth_date).format('YYYY-MM-DD'),
            alamat: formData.value.alamat,
            jenis_kelamin: formData.value.jenis_kelamin,
            nik: formData.value.nik,
            type : 'rcu'
        }

        if (status.valid) {
            let data = Object.keys(payloadData)
            .map(
            key =>
                encodeURIComponent(key) +
                "=" +
                (payloadData[key] === false || payloadData[key] === undefined || payloadData[key] === ''
                ? ''
                : encodeURIComponent(payloadData[key]))
            ).join("&")
                        ...
                        <v-col cols="12" sm="12" lg="8">
                            <v-form ref="formUser" v-model="valid" lazy-validation>
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                        <v-text-field v-model="formData.phone" type="text" label="Nomor Telepon"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                    ...
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                        <v-text-field label="NIK" v-model="formData.nik" :rules="rules.nikRules" required clearable></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                        <v-select
                                          label="Jenis Kelamin"
                                    ...
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                        <v-text-field label="Tempat Lahir" v-model="formData.birth_place" :rules="rules.birth_placeRules" required clearable></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                    ...
                                    <v-col cols="12" sm="6" md="6" lg="6">
                                        <v-textarea label="Alamat" v-model="formData.alamat" :rules="rules.alamatRules" required clearable></v-textarea>
                                    </v-col>
                                </v-row>
                                <v-card-actions>
                                    <NuxtLink to="/siswa" style="text-decoration: none;">
                                        <v-btn color="warning" variant="flat" class="ml-n2 me-2" size="small"> Kembali </v-btn>
                                    </NuxtLink>
