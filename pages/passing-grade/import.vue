<template>
    <div id="app">
        <v-card class="mx-auto">
            <v-card-title class="text-h4" style="line-height: 3rem;">Import passing grade</v-card-title>
            <v-card-text>
                <div class="mb-4 mt-2">
...
<script lang="ts">
    ...
    sessionStorage.path = '/passing-grade/import'
    ...
    export default {
        ...
        methods: {
            ...
            submitForm: async function (ev:any) {
                ...
                var urlSubmit = "/import/passing-grade";
            ...
            downloadTemplate () {
                this.showHideSpinner = true 
                this.overlay = true
                authFetch('/download/download_template_passinggrade', {
                    method: "GET",
                ...
                .then((response) => {
                    ...
                    link.href = url
                    link.download = 'passing-grade-import.xlsx';
                    link.click()
                });
            }
        },
