<template>
    <div id="app">
        <v-card class="mx-auto">
            <v-card-title class="text-h4" style="line-height: 3rem;">Import user SSC</v-card-title>
            <v-card-text>
                <div class="mb-4 mt-2">
                ...
                />
                <p class="text-blue mb-2">*password default 12345678</p>
                <v-spacer></v-spacer>
...
<script lang="ts">
    ...
    sessionStorage.path = '/siswa/import';
    ...
    export default {
        ...
        methods: {
            ...
            downloadTemplate () {
                this.showHideSpinner = true 
                this.overlay = true
                authFetch('/download/download_template_siswa', {
                    method: "GET",
                ...
                .then((response) => {
                    ...
                    link.href = url
                    link.download = 'siswaimport.xlsx';
                    link.click()
                });
            }
        },
